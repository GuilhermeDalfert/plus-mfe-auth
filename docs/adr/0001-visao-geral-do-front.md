...
1. Reutilizável em múltiplos contextos (architecture em micro frontends)
...
- **Autenticação**: Token em localStorage é vulnerável a XSS (A confirmar: considerar httpOnly cookies)

---

## Alternativas Consideradas

### 1. **Monolito (Sem Module Federation)**
- **Rejeitada**: Falta flexibilidade para reutilização em múltiplos shells
- **Rejeitada**: Deployment acoplado

### 2. **Redux para State Management**
...
### 4. **Styled Components vs Material-UI + CSS-in-JS**
